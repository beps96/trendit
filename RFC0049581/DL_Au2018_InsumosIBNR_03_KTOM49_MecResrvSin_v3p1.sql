 ...
 --       se omiten de este script acentos y dieresis principalmente.
   ...
   --drop table bddldes.aut_mec_reserva_siniestro;
    ...
    CREATE EXTERNAL TABLE bddldes.aut_mec_reserva_siniestro (
     ...
     -- ,desc_cobertura_info                char(50)    /* <== 20180920 AUT_ConsDef_CC001.- Se cambia origen de descripciones */
        ...
        ,cve_cve_caracteristica_t           char(3)       /* <== 20180920 AUT_ConsDef_CC003.- Se descomenta campo */
        ,cve_cve_operacion_contable         char(3)
        ...
        ,tabla_origen                       char(8)
        ,sistorig                           char(4)
    ) STORED AS PARQUET LOCATION 'hdfs://nameservice1/consumo/desc/aut_mec_reserva_siniestro';
    ...
    select
     ...
     -- cast(DSMCT_info    as char(50))    as desc_cobertura_info,            /* <== 20180920 AUT_ConsDef_CC001.- Se cambia origen de descripciones */
        cast(desr_CDMCT    as char(50))    as desc_cobertura,                 /* <== 20180920 AUT_ConsDef_CC001.- Se cambia origen de descripciones */
        ...
        cast(tccdcatr      as char(3))     as cve_cve_caracteristica_t,        /* <== 20180920 AUT_ConsDef_CC003.- Se descomenta campo */
        cast(tccopera      as char(3))     as cve_cve_operacion_contable,
                    ...
                    from (
                     ...
                     union
                            select
                                ...
                                cast(concat(substr(cast (fecontab as string),1,4),'-',substr(cast (fecontab as string),5,2),'-',substr(cast (fecontab as string),7,2)) as timestamp) as fecontab_fch,
  ...
  --------------------------------
   --- 
    ...
    ----------  muestra ejemplo  ----------------------------------------------------------------------------------------
    where cve_siniestro in ('0004183174','0000429035','0002716645','0014398184','0071454730','0079342119','0050406990','0049725005',
                            '0075842088','0063900674','0064612880','0067140475','0068016724','0043399450','0044233385','0042004747','0021538996','0044599934',
                            '0042369785','0039068762','0041919481','0043229657','0045723137','0065068777','0059570283','0042219618','0042219618',
                            '0044588176','0045973534','0042923326','0048020655','0042031781','0001005743','0002589919','0000695890','0002528131','0002276830',
                            '0000801373','0002090439','0002009595','0000603928','0001972496'
           ...
           ---------------------------------------------------------------------------------------------------------------------
    order by cve_siniestro, num_movimiento
    ;
