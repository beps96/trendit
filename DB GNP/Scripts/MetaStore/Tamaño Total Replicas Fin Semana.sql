SELECT
	CONCAT(CAST(SUM(SumSizeX1) as CHAR(50)), ' TB') as SumSizeX1,
	CONCAT(CAST(SUM(SumSizeX3) as CHAR(50)), ' TB') as SumSizeX3
FROM
	(
	select
		SUM(CAST(d.PARAM_VALUE AS UNSIGNED)) / 1099511627776 as SumSizeX1,
		SUM(CAST(d.PARAM_VALUE AS UNSIGNED))* 3 / 1099511627776 as SumSizeX3
	from
		metastore.TBLS t
