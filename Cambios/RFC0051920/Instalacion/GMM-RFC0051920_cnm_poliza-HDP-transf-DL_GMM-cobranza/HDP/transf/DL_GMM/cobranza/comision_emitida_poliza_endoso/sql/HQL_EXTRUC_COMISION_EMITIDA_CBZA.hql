drop table if exists bddldes.stg_comision_emitida_poliza_endoso_cbza;
drop table if exists bddldes.stg_comision_emitida_poliza_endoso_cbza_estadistico_e_cbza;
drop table if exists bddldes.stg_comision_emitida_poliza_endoso_cbza_repro;
drop table if exists bddldes.stg_comision_emitida_poliza_endoso_cbza_idmd5;
--------------------------------------------------------------------------------------------------

CREATE TABLE if not exists bddldes.stg_comision_emitida_poliza_endoso_cbza
(
	am_contable								int
...
--------------------------------------------------------------------------------------------------
CREATE TABLE if not exists bddldes.stg_comision_emitida_poliza_endoso_cbza_estadistico_e_cbza
(
	am_contable								int
	,fch_contable							timestamp
	,num_poliza								varchar(14)
...
--------------------------------------------------------------------------------------------------
CREATE TABLE if not exists bddldes.stg_comision_emitida_poliza_endoso_cbza_repro
(
	am_contable								int
	,fch_contable							timestamp
	,num_poliza								varchar(14)
...
--------------------------------------------------------------------------------------------------
CREATE TABLE if not exists bddldes.stg_comision_emitida_poliza_endoso_cbza_idmd5
(
	am_contable								int
	,fch_contable							timestamp
	,num_poliza								varchar(14)
