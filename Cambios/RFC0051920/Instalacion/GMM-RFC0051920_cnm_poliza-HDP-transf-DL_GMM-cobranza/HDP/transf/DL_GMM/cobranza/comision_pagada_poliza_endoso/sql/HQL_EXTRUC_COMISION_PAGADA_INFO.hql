CREATE TABLE if not exists bddldes.stg_comision_pagada_poliza_endoso
(
	am_contable								int
...
------------------------------------------------------------------------------------------------
CREATE TABLE if not exists bddldes.stg_comision_pagada_poliza_endoso_estadistico_p_info
(
	am_contable								int
	,fch_contable							timestamp
	,num_poliza								varchar(14)
...
------------------------------------------------------------------------------------------------
CREATE TABLE if not exists bddldes.stg_comision_pagada_poliza_endoso_repro
(
	am_contable								int
	,fch_contable							timestamp
	,num_poliza								varchar(14)
...
------------------------------------------------------------------------------------------------
CREATE TABLE if not exists bddldes.stg_comision_pagada_poliza_endoso_idmd5
(
	am_contable								int
	,fch_contable							timestamp
	,num_poliza								varchar(14)
