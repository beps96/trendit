...
HADOOP_USER_NAME=usrdes01 spark2-submit --master yarn --driver-memory 32G --executor-memory 32G --conf spark.yarn.executor.memoryOverhead=10G --conf spark.yarn.driver.memoryOverhead=10G --num-executors 32 --executor-cores 5 --driver-class-path /etc/hive/conf/ /tmp/paso/salvamentos_union.py bddlalm.aut_reserva_salvamentos bddldes.aut_siniestro_cob_afecta_insumo_nvos_parquet bddldes aut_siniestro_cob_afecta_insumo_comp
