...
HADOOP_USER_NAME=usrdes01 spark2-submit --master yarn --driver-memory 2G --executor-memory 4G --num-executors 30 --driver-class-path /etc/hive/conf/ /tmp/paso/Salvamentos_v3.py bddlcru.krem24 bddlcru.kcgm13t bddldes.aut_siniestro_cob_afecta_insumo_nvos_parquet bddldes.aut_mec_reserva_siniestro_parquet bddldes.aut_salvamento_estimado bddlalm.aut_siniestro_afectado bddlcru.kpem08t bddlcru.ktctget bddlalm.aut_siniestro bddlcru.ksincvt bddlcru.ktpt2it bddlcru.ksim3ah bddlalm aut_reserva_salvamentos
