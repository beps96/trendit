...
SELECT 
	...
	des_estatus_poliza,cve_forma_pago,des_forma_pago,clave_intermediario_principal,nombre_intermediario_principal,fch_ini_vigencia,fch_fin_vigencia,
	rfc_contratante,nombre_contratante	,cve_circulo_medico_contratado	,des_circulo_medico_contratado	,fch_ini_poliza	,fch_emision,am_emision	,
	cve_experiencia,des_experiencia,cve_pool,des_pool,cve_subramo_admon,des_subramo_admon,cve_plan,des_plan,ban_coaseguro_cero,cve_usuario,
	...
	fch_registro_producto,num_registro_producto	,num_aseg_dependientes,num_aseg_titulares,registro_producto_recas,
