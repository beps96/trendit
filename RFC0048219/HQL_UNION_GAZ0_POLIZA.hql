DROP TABLE IF EXISTS BDDLTRN.STG_CNM_CBZA_UNION_GAZ0_POLIZA PURGE;
CREATE TABLE IF NOT EXISTS BDDLTRN.STG_CNM_CBZA_UNION_GAZ0_POLIZA AS
 SELECT pol_oficina, pol_numero,pol_ofi_renovac,pol_num_renovac,
    ...
    pol_unidad_suma_aseg15, pol_unidad_deducible15
...
SELECT hisp_oficina as pol_oficina, hisp_numero as pol_numero,hisp_ofi_renovac as pol_ofi_renovac,hisp_num_renovac as pol_num_renovac ,
    ...
    hisp_unidad_suma_aseg15 as pol_unidad_suma_aseg15, hisp_unidad_deducible15 as pol_unidad_deducible15  
