...
HADOOP_USER_NAME=usrdes01 spark2-submit --master yarn --driver-memory 2G --executor-memory 4G --num-executors 30 --driver-class-path /etc/hive/conf/ /tmp/paso/salvamento_estimado.py bddlcru bddlint bddldes ktctget coberturas_afectas fnz_tipo_cambio ksim61h ksim61t ksim10 aut_salvamento_estimado
