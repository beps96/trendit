create table bddlapr.aut_insumos_sb1_emision_cobertura_optm as
select
...
,
	...
	cast(acc.cve_compania_coaseguradora as CHAR(10)) as cve_compania_coaseguradora ,
	cast(ancc.desc_compania_coaseguradora as CHAR(30)) as nombre_compania_coaseguradora ,
...
,
	...
	case
		when coalesce(trim(acc.cve_compania_coaseguradora),
...
LEFT JOIN bddldes.aut_companias_coaseguradora acc ON
	aaa.cve_contrato_coaseguro = acc.cve_contrato_coaseguro
LEFT JOIN bddldes.aut_nom_companias_coaseguradora ancc
	--(kcim44b1 )
 ON
	acc.cve_compania_coaseguradora = ancc.cve_compania_coaseguradora
	AND ancc.cve_compania_coaseguradora IS NOT NULL
